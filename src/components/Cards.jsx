  ...
  return (
    <div className='w-full h-screen bg-zinc-900 flex gap-5 px-16 items-center'>
      <div className="Cardcontainer w-1/2 h-[55vh]">
        <div className="card relative w-full  h-full bg-[#073932] shadow-lg shadow-zinc-600 rounded-xl flex items-center justify-center">
      ...
      <div className="Cardcontainer w-1/2 h-[55vh] flex gap-5">
        <div className="card w-1/2 h-full bg-[#000000] shadow-lg shadow-zinc-700 flex items-center justify-center relative rounded-xl">
